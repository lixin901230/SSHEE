...
insert  into `t_sys_role`(`id`,`roleName`,`roleType`,`createTime`,`lastUpdateTime`,`state`,`remark`) values (1,'超级管理员','1','2013-11-13 14:11:52','2014-04-01 15:45:32',1,'拥有系统所有权限'),(2,'系统管理员','2','2013-11-18 14:12:28','2014-04-01 15:45:50',1,'拥有除授权管理的所有权限'),(3,'普通用户','3','2013-11-18 14:13:08','2014-02-19 23:17:46',1,'拥有除系统管理模块外的访问权限');
...
insert  into `t_sys_user$role`(`userId`,`roleId`) values (1,1),(3,3),(4,3),(2,2),(5,3);
