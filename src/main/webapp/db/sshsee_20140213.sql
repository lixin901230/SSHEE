...
CREATE TABLE `t_sys_organization` (
  ...
  `state` int(11) DEFAULT NULL COMMENT '节点状态，是closed还是open',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `t_sys_user_group` (
  ...
  `createTime` datetime DEFAULT NULL COMMENT '建创时间',
  `lastUpdateTime` datetime DEFAULT NULL COMMENT '近最修改时间',
  `state` int(11) DEFAULT NULL COMMENT '状态，1：可以，0：不可用',
...
INSERT INTO `t_sys_resource` VALUES ('104', '1', 'authMan', '授权管理', '', ', index_icon_center', '2014-02-13 00:28:32', '1', '4', '1', '菜单', 'open');
...
INSERT INTO `t_sys_resource` VALUES ('1050107', '10501', 'userGroupExcelTemplate', '用户组导入模板', '', '', '2014-02-13 00:07:05', '2', '7', '1', '功能点', '');
...
INSERT INTO `t_sys_resource` VALUES ('106', '1', 'orgMan', '组织机构管理', '', 'menu_icon_org_man', '2013-12-29 17:56:14', '1', '5', '1', '菜单', 'closed');
INSERT INTO `t_sys_resource` VALUES ('10601', '106', 'orgList', '机构列表', '/sysman/userGroupAction!toUserGroupListPage.action', '', '2014-02-13 00:07:22', '2', '1', '1', '功能菜单', 'open');
INSERT INTO `t_sys_resource` VALUES ('1060101', '10601', 'orgDetail', '机构查看', '', '', '2014-02-13 00:07:20', '2', '1', '1', '功能点', '');
INSERT INTO `t_sys_resource` VALUES ('1060102', '10601', 'orgAdd', '机构添加', '', '', '2014-02-13 00:07:18', '2', '2', '1', '功能点', '');
INSERT INTO `t_sys_resource` VALUES ('1060103', '10601', 'orgAddUser', '机构加入用户', '', '', '2014-02-13 00:07:15', '2', '3', '1', '功能点', '');
INSERT INTO `t_sys_resource` VALUES ('1060104', '10601', 'orgRemoveUser', '机构移除用户', '', '', '2014-02-13 00:07:13', '2', '4', '1', '功能点', '');
INSERT INTO `t_sys_resource` VALUES ('1060105', '10601', 'orgEdit', '机构编辑', null, null, '2014-02-13 00:07:10', '2', '5', '1', '功能点', null);
INSERT INTO `t_sys_resource` VALUES ('1060106', '10601', 'orgDel', '机构删除', '', '', '2014-02-13 00:07:08', '2', '6', '1', '功能点', '');
INSERT INTO `t_sys_resource` VALUES ('1060107', '10601', 'orgExcelTemplate', '机构导入模板', '', '', '2014-02-13 00:07:05', '2', '7', '1', '功能点', '');
INSERT INTO `t_sys_resource` VALUES ('1060108', '10601', 'orgImport', '机构导入', '', '', '2014-02-13 00:07:01', '2', '8', '1', '功能点', '');
INSERT INTO `t_sys_resource` VALUES ('1060109', '10601', 'orgExport', '机构导出', '', '', '2014-02-13 00:11:16', '2', '9', '1', '功能点', null);
...
INSERT INTO `t_sys_role` VALUES ('3', '普通用户', '3', '2013-11-18 14:13:08', '2014-02-13 02:43:57', '1', '拥有除系统管理模块外的访问权限');
