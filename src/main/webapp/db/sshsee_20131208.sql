...
CREATE TABLE `t_sys_resource` (
  ...
  `statu` int(11) DEFAULT NULL COMMENT '状态，0：可以，1：不可用',
  `remark` varchar(255) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`)
...
-- Records 
-- ----------------------------
INSERT INTO `t_sys_resource` VALUES ('0', 'ROOT_NODE', 'welcome', '首页', '${pageContext.request.contextPath}/view/common/layout/portal.jsp', '2013-12-08 16:07:10', '1', '1', '1', '系统登陆成功后的展示页');
INSERT INTO `t_sys_resource` VALUES ('1', '0', 'sysMan', '系统管理', null, '2013-12-08 16:52:06', '0', '1', '1', '模块');
INSERT INTO `t_sys_resource` VALUES ('101', '1', 'userMan', '用户管理', null, '2013-12-08 16:54:44', '1', '1', '1', '菜单');
