            ...
            case 3:
                var iss, fnpop = function(obj, call){
                    ...
                    var pageii = $.layer({
                        ...
                        page: {
                            html: '<div style="width:'+ (obj.area ? obj.area[0]-40 : 160) +'px; height:'+ (obj.area ? obj.area[1]-40 : 160) +'px; padding:20px; background-color:#eee;"><p>我从'+ (obj.where || '下') +'边来，我自定了风格。</p><button class="pagebtn btns" >关闭</button></div>'
        ...
        case 'tab':
            ...
            layer.tab({
                ...
                data: [{
                    ...
                    title: '无题', 
                    content: '<div style="padding:20px; line-height:30px; text-align:center">一入前端深似海，从此妹纸是浮云。<br>以下省略若干字。。。</div>'
                }]
            });
        break;
        case 'photos':
